...
<div class="page-content">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('blogs.index')}}">Blog
                            List</a></li>
    ...
    <section class="section">
        <div class="card border shadow-sm">
            <div class="card-body">
                <form action="{{ route('blogs.update', $blogs->id) }}" id="BlogEdit" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-1">
                            ...
                            <div>
                                @if ($blogs->image != null)
                                    <img id="blah1" src="{{  $blogs->image }}" height="50px" width="50px">
                                @else
                        ...
                        <div class="form-group mb-3 mt-3 col-md-12">
                            ...
                            <textarea name="description" id="summernote" class="form-control" placeholder="Enter Description">{!! $blogs->content !!}</textarea>
                        </div>
                    </div>
