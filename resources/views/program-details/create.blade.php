...
@section('title', __('Add Program Details'))
@section('content')
...
<div class="page-content">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Program Details</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section class="section">
        <div class="card border shadow-sm">
            <div class="card-body">
                <form action="{{ route('program-details.store') }}" id="AddProgramDetails" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <h6 class="form-label" for="title">Select Program</h6>
                            <div class="input-group">
                                <select name="program_id" id="single-select" class="form-control program_id" required>
