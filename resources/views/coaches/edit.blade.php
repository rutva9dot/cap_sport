...
<div class="page-content">
    ...
    <section class="section">
        <div class="card border shadow-sm">
            <div class="card-body">
                <form action="{{ route('coaches.update', $coaches->id) }}" id="EditCoaches" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-1">
                            ...
                            <div>
                                @if ($coaches->image != null)
                                    <img id="blah1" src="{{  $coaches->image }}" height="50px" width="50px">
                                @else
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="designation" name="designation" value="{{ $coaches->designation }}"
                            ...
                            <div class="input-group">
                                <select name="country_id" id="single-select" class="form-control country_id" required>
                                    ...
                                    @foreach ($countries as $venue)
                                        <option value="{{ $venue->id }}" {{ $coaches->country_id == $venue->id ? 'selected' : '' }}>
                                            {{ $venue->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <textarea name="certification" class="form-control" id="certification" rows="3" placeholder="Enter Certification">{{ $coaches->certification }}</textarea>
                            </div>
                            <div class="error-message"></div>
                        </div>
                        ...
                        <div class="form-group mb-3 mt-3 col-md-12">
                            ...
                            <textarea name="about" id="summernote" class="form-control" placeholder="Enter Profile Summary">{!! $coaches->about !!}</textarea>
                        </div>
                    </div>
