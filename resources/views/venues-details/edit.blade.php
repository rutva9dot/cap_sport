...
@section('title', __('Edit Venue Details'))
@section('content')
...
<div class="page-content">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Venue Details</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section class="section">
        <div class="card border shadow-sm">
            <div class="card-body">
                <form action="{{ route('venue-details.update', $venueDetails->id) }}" method="post" id="EditVenueDetails" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="title" name="title" value="{{ $venueDetails->title }}"
                            ...
                            <div class="input-group">
                                <select name="venue_id" id="single-select" class="form-control venue_id" required>
                                    ...
                                    @foreach ($venues as $venue)
                                        <option value="{{ $venue->id }}" {{ $venueDetails->venue_id == $venue->id ? 'selected' :
                                            '' }}>
                                            {{ $venue->name }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="col-md-1 mt-3">
                            ...
                            <div>
                                @if ($venueDetails->image != null)
                                    <img id="blah1" src="{{  $venueDetails->image }}" height="50px" width="50px">
                                @else
                        ...
                        <div class="form-group mb-3 mt-3 col-md-12">
                            ...
                            <textarea name="content" class="form-control" placeholder="Enter Content" id="summernote" required>{!! $venueDetails->content !!}</textarea>
                        </div>
                    </div>
