...
<form class="g-3" action="{{ route('banners.store') }}" method="post" enctype="multipart/form-data">
    @csrf
...
<script>
    ...
    // Function to reset the modal and image source
    function resetModal() {
        image.src = "{{ asset('assets/images/preview_image.png') }}"; // Reset image source
        if (cropper) {
            cropper.destroy();
            cropper = null;
        }
    ...
    $modal.on('shown.bs.modal', function() {
        ...
        resetModal(); // Reset modal and cropper when hidden
    });
