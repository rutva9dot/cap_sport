...
<div class="page-content">
    ...
    <section class="section">
        <div class="card border shadow-sm">
            <div class="card-body">
                <form action="{{ route('faqs.update', $fAQs->id) }}" id="AddFAQs" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="question" name="question" placeholder="Enter Question" value="{{ $fAQs->question }}"/>
                            </div>
                        ...
                        <div class="form-group mb-3 mt-3 col-md-12">
                            ...
                            <textarea name="answer" id="summernote" class="form-control" placeholder="Enter Answer">{!! $fAQs->answer !!}</textarea>
                        </div>
                    </div>
